...
import ArowwIcon from "../../../asset/click-arrow.png";
...
const groups = ["ㄱ → ㅎ", "ㅎ → ㄱ"];

interface SortSelectorPurpleProps {
...
export default function SortSelectorPurple() {
  const theme = useTheme();
  const [personName, setPersonName] = React.useState<string>(groups[0]);
